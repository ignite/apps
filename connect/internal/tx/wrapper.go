...
// GetMsgs implements Tx.
func (w wrappedTx) GetMsgs() []sdk.Msg {
	panic("not implemented")
}

// GetMsgsV2 implements Tx.
func (w wrappedTx) GetMsgsV2() ([]protov2.Message, error) {
	msgs := make([]protov2.Message, len(w.Tx.Body.Messages))
	for i, msg := range w.Tx.Body.Messages {
		msgs[i] = msg
	}
