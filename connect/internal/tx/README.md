...
classDiagram
    class Factory {
        ...
        Prepare() error
        BuildUnsignedTx(msgs ...sdk.Msg) error
        BuildsSignedTx(ctx context.Context, msgs ...sdk.Msg) (Tx, error)
        calculateGas(msgs ...sdk.Msg) error
        Simulate(msgs ...sdk.Msg) (*apitx.SimulateResponse, uint64, error)
        UnsignedTxString(msgs ...sdk.Msg) (string, error)
        BuildSimTx(msgs ...sdk.Msg) ([]byte, error)
